...
<body onload="window.print();">
    ...
    <hr>
        <div class="isi">
        <h2 style="text-align:center;text-transform: uppercase;">SURAT KETERANGAN KEMATIAN</h2>
    ...
    <h5>:&nbsp<?php echo $row['umur']?> </h5>
    <h5>:&nbsp<?php echo $row['anak_ke']?> </h5>
    </div>
            </div>
<h5 style="margin-left:50px; margin-top:10px;margin-bottom:10px;">telah meninggal dunia pada :</h5>
            <div class="row">
    <div class="col-md-4">
    <h5>Hari</h5>
    <h5>tanggal</h5>
    <h5>Jam </h5>
    <h5>Di</h5>
    <h5>Disebabkan karena</h5>


    </div>
    <div class="col-md-8">
    <h5>:&nbsp<?php echo $row['hari_meninggal'] ?></h5>
    <h5>:&nbsp<?php echo $row['tanggal']?> </h5>
    <h5>:&nbsp<?php echo $row['jam']?> </h5>
    <h5>:&nbsp<?php echo $row['lokasi']?> </h5>
    <h5>:&nbsp<?php echo $row['penyebab']?> </h5>

    </div>
    <h5 style="margin-top:50px;margin-bottom:100px;">Demikian surat keterangan ini dibuat atas dasar yang sebenarnya.</h5>
