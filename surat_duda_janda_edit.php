...
<?php
	...
	if(isset($_POST['add'])){
		...
		//tgl_surat='$tgl_surat'
		$update = mysqli_query($koneksi, "UPDATE surat_duda_janda SET status_surat='$status_surat',ket_surat='$ket_surat',tgl_surat='$tgl_surat' WHERE id='$id'") or die(mysqli_error());
		if ($update) {
		?>
	...
	?>
		<h2>Data Surat Duda / Janda &raquo; Proses</h2>
		<hr />
		<form class="form-horizontal" action="" method="post">
			<div class="row">
				<div class="col-md-4">
					<img src="img/<?php echo $row['s_ktp']?>" alt="" width="350">
			...
			<div class="row">
				<div class="col-md-4">
					<img src="img/<?php echo $row['s_kematian']?>" alt="" width="300" height="350">
					<p style="text-align:center;">Surat Kematian</p>
				</div>
				<div class="col-md-4">
					<img src="img/<?php echo $row['s_cerai']?>" alt="" width="300" height="350">
					<p style="text-align:center;">Surat Cerai</p>
				</div>
				<div class="col-md-4">
	...
	<div class="form-group">
		...
		<input type="text" name="nama" value="<?php echo $row['nama'] ?>" class="form-control"
			...
			<div class="form-group">
				...
				<input type="text" name="status" value="<?php echo $row['status'] ?>" class="form-control" placeholder="Alamat" disabled></required>
			</div>
			<div class="form-group">
				<label class="control-label">Mantan</label>
				<input type="text" name="mantan" value="<?php echo $row['mantan'] ?>" class="form-control" placeholder="Alamat" disabled></required>
			</div>
			<div class="form-group">
