<?php
    ...
    include	('library.php');
		if(isset($_POST['qcari'])) {
			$qcari=$_POST['qcari'];
			$mySql="SELECT * FROM surat_duda_janda WHERE nik like '%$qcari%' or nama like '%$qcari%' or no_surat like '%$qcari%' or tgl_surat like '%$qcari%'";
		}
	?>
<!DOCTYPE html>
<html lang="en">
...
<body onload="window.print();">
    ...
    <hr style="hight:3px!important;">
        <div class="isi">
        <h2 style="text-align:center;text-transform: uppercase;">Laporan SURAT DUDA / JANDA</h2>
...
?>
		<tr>
            ...
            <td><?php echo $kolomData['agama']; ?></td>
            <td><?php echo $kolomData['pekerjaan']; ?></td>
			<td><?php echo $kolomData['alamat']; ?></td>
		</tr>
	<?php } ?>
				</table>
                <h5>Jumlah data surat Duda / Janda : &nbsp <?php echo $nomor-1 ?></h5>
				</div>
			</div>
