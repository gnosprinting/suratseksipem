...
if(isset($_POST['qcari'])) {
	...
	$mySqlChrt="SELECT * FROM surat_ijin_keramaian WHERE tgl_surat like '%$qcari%' GROUP BY tgl_surat";
	$count= "SELECT COUNT(id) as jumlah FROM surat_ijin_keramaian WHERE tgl_surat like '%$qcari%' GROUP BY tgl_surat";
}
?>
<div>
...
<div class="card">
	<h2 style="margin:10px;">Data Surat Keramaian</h2>
	<div class="form-group">
			<a href="surat_keramaian_cetak.php" class="btn btn-sm btn-primary " style="margin-left:10px;">Cetak Data</a>
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="statistik_keramaian.php">
			...
			<?php $mycount = mySqli_query ($koneksi, $count) or die ("Query salah : ".mysqli_error ($koneksi)); ?>
					...
					var myChart = new Chart(ctx, {
							...
							data: {
									...
									datasets: [{
													label: 'Jumlah Pengajuan Surat Ijin Keramaian : <?php echo mysqli_num_rows($myQry1); ?>',
