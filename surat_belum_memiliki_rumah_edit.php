...
<?php
	...
	if(isset($_POST['add'])){
		...
		//tgl_surat='$tgl_surat'
		$update = mysqli_query($koneksi, "UPDATE surat_belum_memiliki_rumah SET status_surat='$status_surat',ket_surat='$ket_surat',tgl_surat='$tgl_surat' WHERE id='$id'") or die(mysqli_error());
		if ($update) {
		?>
		...
		<meta http-equiv='refresh' content='3; url=surat_belum_memiliki_rumah.php'/>
		<?php
		}else{
	...
	?>
		<h2>Data Surat Belum Memiliki Rumah &raquo; Proses</h2>
		<hr />
