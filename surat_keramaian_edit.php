...
<?php
	...
	if(isset($_POST['add'])){
		...
		//tgl_surat='$tgl_surat'
		$update = mysqli_query($koneksi, "UPDATE surat_ijin_keramaian SET status_surat='$status_surat',ket_surat='$ket_surat',tgl_surat='$tgl_surat' WHERE id='$id'") or die(mysqli_error());
		if ($update) {
		?>
		...
		<meta http-equiv='refresh' content='3; url=surat_keramaian.php'/>
		<?php
		}else{
	...
	?>
		<h2>Data Surat Ijin Keramaian &raquo; Proses</h2>
		<hr />
		<form class="form-horizontal" action="" method="post">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<p style="text-align:center;">PBB</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4">
