...
<?php
	...
	if(isset($_POST['add'])){
		...
		//tgl_surat='$tgl_surat'
		$update = mysqli_query($koneksi, "UPDATE surat_ektp SET status_surat='$status_surat',ket_surat='$ket_surat',tgl_surat='$tgl_surat' WHERE id='$id'") or die(mysqli_error());
		if ($update) {
		?>
	...
	?>
		<h2>Data Surat E-KTP &raquo; Proses</h2>
		<hr />
		<form class="form-horizontal" action="" method="post">
			<div class="row">
				...
				<div class="col-md-4">
					<img src="img/<?php echo $row['s_foto']?>" alt="" width="350">
					<p style="text-align:center;">Pas Photo</p>
				</div>
			</div>
  <div class="row">
    <div class="col">
