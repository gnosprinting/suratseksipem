...
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_ektp WHERE tgl_surat like '%$qcari%'";
	$mySqlChrt="SELECT * FROM surat_ektp WHERE tgl_surat like '%$qcari%' GROUP BY tgl_surat";
	$count= "SELECT COUNT(id) as jumlah FROM surat_ektp WHERE tgl_surat like '%$qcari%' GROUP BY tgl_surat";
	//SELECT COUNT(id) as jumlah FROM surat_ektp WHERE tgl_surat GROUP BY tgl_surat;
}
?>
<div>
...
<h2 style="margin:10px;">Data Pengantar E-KTP</h2>
		<div class="form-group">
			...
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="statistik_ektp.php">
			...
			<?php $mycount = mySqli_query ($koneksi, $count) or die ("Query salah : ".mysqli_error ($koneksi)); ?>
					...
					var myChart = new Chart(ctx, {
							...
							data: {
									...
									datasets: [{
													label: 'Jumlah Pengajuan e-KTP: <?php echo mysqli_num_rows($myQry1); ?>',
