					...
					if ($ukuran_ktp < (2*1024*1024)) {
						if (in_array($ekstensi_kk, $ekstensi_diperbolehkan) === true) {
							if ($ukuran_kk < (2*1024*1024)) {
								...
								//insert to database
								$insert = mysqli_query($koneksi, "INSERT INTO surat_domisili( nama, nik, tgl_lhr, tempat_lhr, jk,agama,pekerjaan,alamat,s_pengantar,s_ktp,s_kk,status_surat)
								VALUES('$nama','$nik','$tanggal', '$tempat_lhr', '$jk','$agama','$pekerjaan', '$alamat','$s_pengantar','$s_ktp','$s_kk','$status_surat')") or die (mysqli_error ($koneksi));
								if($insert){
									...
									<meta http-equiv="refresh" content="50; url=surat_domisili.php"/>';
								}else{
  ...
  <div class="row">
    ...
    <div class="col">
			<div class="form-group">
				...
				<input type="text" readonly="true" name="agama" value="<?php echo $row['agama']; ?>" class="form-control" placeholder="agama"></required>
			</div>
			<div class="form-group">
				<label class="control-label">Pekerjaan</label>
				<input type="text" readonly="true" name="pekerjaan"  value="<?php echo $row['pekerjaan']; ?>" class="form-control" placeholder="perkerjaan" required>
			</div>
			<div class="form-group">
