...
include ('header.php');
$mySql="SELECT * FROM surat_ijin_keramaian WHERE status_surat='diproses'";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	// $mySql="SELECT * FROM surat_ijin_keramaian WHERE id like '%$qcari%' or nik like '%$qcari%' or nama like '%$qcari%' ";
	$mySql="SELECT * FROM surat_ijin_keramaian WHERE status_surat='diproses' nik like '%$qcari%' or nama like '%$qcari%' or no_surat like '%$qcari%' or tgl_surat like '%$qcari%'";
}
?>
<div class="card">
	<h2 style="margin:10px;">Data Surat Ijin Keramaian</h2>
		<div class="form-group">
			...
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="surat_keramaian.php">
...
?>
		<tr>
			...
			<td>
				...
				?>
				<a href="surat_keramaian_hapus.php?id=<?php echo $kolomData['id'];?>" title="Hapus data" onClick="confirm ('Yakin menghapus Data ini?')" class="btn btn-danger btn-sm">
				hapus</a>
				<?php
					}
				?>
				...
				?>
				<!-- <a href="surat_keramaian_edit.php?id=<?php //echo $kolomData['id'];?>" class="btn btn-sm btn-warning" style="margin-top:5px;">Proses surat</a>
				<a href="surat_keramaian_hapus.php?id=<?php //echo $kolomData['id'];?>" title="Hapus data" onClick="confirm ('Yakin menghapus Data ini?')" class="btn btn-danger btn-sm">
				hapus</a> -->
				<?php
					//}
				...
				?>
				<a href="surat_keramaian_selesai.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-warning" style="margin-top:5px;">Selesaikan surat</a>
				<a href="surat_keramaian_hapus.php?id=<?php echo $kolomData['id'];?>" title="Hapus data" onClick="confirm ('Yakin menghapus Data ini?')" class="btn btn-danger btn-sm">
				hapus</a>
				<a href="surat_keramaian_cetak.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-success" style="margin-top:5px;">cetak surat</a>
				<?php
					}
				?>
				<?php
