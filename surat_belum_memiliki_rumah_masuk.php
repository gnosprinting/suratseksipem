...
include ('header.php');
$mySql="SELECT * FROM surat_belum_memiliki_rumah WHERE status_surat='diproses'";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_belum_memiliki_rumah WHERE status_surat='diproses' and nik like '%$qcari%' or nama like '%$qcari%' or no_surat like '%$qcari%' or tgl_surat like '%$qcari%'";
}
?>
<div class="card">
	<h2 style="margin:10px;">Data Surat Belum Memiliki Rumah</h2>
		<div class="form-group">
			...
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="surat_belum_memiliki_rumah.php">
								<input type="text" class="form-control" name="qcari" placeholder="Cari surat surat_belum_memiliki_rumah..." autofocus/>
					</form>
		</div>
			</div>
...
?>
      ...
      <td class="text-center"><?php echo $kolomData['pekerjaan']; ?></td>
			...
			<td>
				...
				?>
				<a href="surat_belum_memiliki_rumah_hapus.php?id=<?php echo $kolomData['id'];?>" title="Hapus data" onClick="confirm ('Yakin menghapus Data ini?')" class="btn btn-danger btn-sm">
				hapus</a>
				<?php
					}
				?>
				...
				?>
				<!-- <a href="surat_belum_memiliki_rumah_edit.php?id=<?php //echo $kolomData['id'];?>" class="btn btn-sm btn-warning" style="margin-top:5px;">Proses surat</a>
				<a href="surat_belum_memiliki_rumah_hapus.php?id=<?php //echo $kolomData['id'];?>" title="Hapus data" onClick="confirm ('Yakin menghapus Data ini?')" class="btn btn-danger btn-sm">
				hapus</a> -->
				<?php
					//}
				...
				?>
				<a href="surat_belum_memiliki_rumah_selesai.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-warning" style="margin-top:5px;">Selesaikan surat</a>
				<a href="surat_belum_memiliki_rumah_hapus.php?id=<?php echo $kolomData['id'];?>" title="Hapus data" onClick="confirm ('Yakin menghapus Data ini?')" class="btn btn-danger btn-sm">
				hapus</a>
				<a href="surat_belum_memiliki_rumah_cetak.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-success" style="margin-top:5px;">cetak surat</a>
				<?php
					}
				?>
				<?php
