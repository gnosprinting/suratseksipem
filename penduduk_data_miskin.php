...
$mySql="SELECT * FROM surat_tidakmampu GROUP BY nik";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_tidakmampu WHERE nik like '%$qcari%' or nama like '%$qcari%' GROUP BY nik";
}

?>

<div class="card">
	<h2 style="margin:10px;">Data Penduduk Miskin</h2>
	<div class="form-group">
		...
		<div class="right"  style="margin-right:10px;">
			<form class="" method="POST" action="penduduk_data_miskin.php">
