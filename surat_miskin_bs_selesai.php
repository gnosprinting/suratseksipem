...
<?php
		...
		$update = mysqli_query($koneksi, "UPDATE surat_miskin_rs SET status_surat='$status_surat' WHERE id='".$_GET['id']."'") or die(mysqli_error());
		if ($update) {
	?>
		...
		<meta http-equiv='refresh' content='1; url=surat_miskin_rs.php'/>
<?php
			}
	}
}
