...
<body onload="window.print();">
    ...
    <hr style="hight:3px!important;">
        <div class="isi">
        <h2 style="text-align:center;text-transform: uppercase;">Laporan SURAT BELUM MEMILIKI RUMAH</h2>
...
<?php
	$mySql = "SELECT * from surat_belum_memiliki_rumah WHERE tgl_surat like '%$qcari%'";
...
?>
	...
	<?php } ?>
                ...
                <h5>Jumlah data surat Domisili : &nbsp <?php echo $nomor-1 ?></h5>
				</div>
			</div>
