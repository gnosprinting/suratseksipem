<?php
    ...
    include	('library.php');
		if(isset($_POST['qcari'])) {
			$qcari=$_POST['qcari'];
			$mySql="SELECT * FROM surat_kematian WHERE nik like '%$qcari%' or nama like '%$qcari%' or no_surat like '%$qcari%' or tgl_surat like '%$qcari%'";
		}
	?>
<!DOCTYPE html>
<html lang="en">
...
<body onload="window.print();">
    ...
    <hr style="hight:3px!important;">
        <div class="isi">
        <h2 style="text-align:center;text-transform: uppercase;">lAPORAN SURAT KEMATIAN</h2>
...
<?php
	$mySql = "SELECT * from surat_kematian WHERE tgl_surat like '%$qcari%'";
...
?>
		<tr>
            ...
            <td><?php echo $kolomData['lokasi']; ?></td>
            <td><?php echo $kolomData['penyebab']; ?></td>

		</tr>
	<?php } ?>
				</table>
                <h5>Jumlah data surat kematian : &nbsp <?php echo $nomor-1 ?></h5>
				</div>
			</div>
