<?php
    ...
    $id = $_GET ['id'];
	$sql = mysqli_query($koneksi, "SELECT * FROM surat_belum_memiliki_rumah WHERE id='$id'");
...
<body onload="window.print();">
    ...
    <hr style="hight:3px!important;">
        <div class="isi">
        <h2 style="text-align:center;text-transform: uppercase;">SURAT KETERANGAN TIDAK MEMILIKI RUMAH</h2>
    ...
    <h5>:&nbsp<?php echo $row['pekerjaan']?> </h5>
		...
		<h5>
			...
			&nbsp Kel. Loktabat Selatan Kec. Banjarbaru Selatan Kota Banjarbaru
		</h5>
		<h5>:&nbspBenar yang bersangkutan Belum memiliki rumah sendiri </h5>
		<h5>:&nbsp<B><?php echo $row['keperluan']?> </B></h5>

    </div>
    <h5 style="margin-top:50px;margin-bottom:100px;text-indent:50px;">Demikian Surat Keterangan ini dibuat dengan sebenarnya, agar yang berkepentingan mengetahui dan dapat dipergunakan sebagaimana mestinya.</h5>
