...
$mySql="SELECT * FROM surat_belum_memiliki_rumah GROUP BY nik";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_belum_memiliki_rumah WHERE nik like '%$qcari%' or nama like '%$qcari%' GROUP BY nik";
}

?>

<div class="card">
	<h2 style="margin:10px;">Data Penduduk Belum Memiliki Rumah</h2>
	<div class="form-group">
		...
		<div class="right"  style="margin-right:10px;">
			<form class="" method="POST" action="penduduk_data_belum_memiliki_rumah.php">
