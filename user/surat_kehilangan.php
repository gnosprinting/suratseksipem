...
$mySql="SELECT * FROM surat_kehilangan WHERE nik = $nik";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_kehilangan WHERE nik like '%$qcari%' or nama like '%$qcari%' ";
}
?>
<div class="card">
	<h2 style="margin:10px;">Data Surat Kehilangan</h2>
		<div class="form-group">
			<a href="surat_kehilangan_tambah.php?nik=<?php echo $nik;?>" class="btn btn-sm btn-primary " style="margin-left:10px;">Tambah data surat kehilangan</a>
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="surat_kehilangan.php">
								<input type="text" class="form-control" name="qcari" placeholder="Cari surat kehilagan..." autofocus/>
					</form>
		</div>
			</div>
...
?>
      ...
      <td class="text-center"><?php echo $kolomData['pekerjaan']; ?></td>
			...
			<td>
				...
				hapus</a>
				<a href="surat_kehilangan_cetak.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-success" style="margin-top:5px;">detail</a>
			</td>
		</tr>
	<?php } ?>
				</table>
