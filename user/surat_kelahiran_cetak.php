...
<body>
    	<h3 style="text-align:center;">PENGAJUAN SURAT kelahiran</h3>
...
<div class="isi">
  <div class="content" style="padding:3% !important;">
	...
	<div class="row">
		<div class="col-md-4">
			<img src="../img/<?php echo $row['s_ktp_suami']?>" alt="" width="450">
			<p style="text-align:center;">KTP Suami</p>
		</div>
		<div class="col-md-4">
			<img src="../img/<?php echo $row['s_ktp_isteri']?>" alt="" width="450">
	...
	<div class="row">
		<div class="col-md-4">
			<img src="../img/<?php echo $row['kartu_lahir']?>" alt="" width="450">
			<p style="text-align:center;">Kartu Lahir</p>
		</div>
		<div class="col-md-4">
			<img src="../img/<?php echo $row['akta_kakak']?>" alt="" width="450">
			<p style="text-align:center;">Akta Kakak</p>
		</div>
		<div class="col-md-4">
			<img src="../img/<?php echo $row['akta_ibu']?>" alt="" width="450">
			<p style="text-align:center;">Akta Ibu</p>
		</div>
		<div class="col-md-4">
			<img src="../img/<?php echo $row['akta_ayah']?>" alt="" width="450">
