...
<body>
    	<h3 style="text-align:center;">PENGAJUAN SURAT duda_janda</h3>
  ...
  <div class="content" style="padding:3% !important;">
    <div class="row">
	    ...
	    <div class="col-md-8">
		    ...
		    <h5>:&nbsp<?php echo $row['mantan']?></h5>
				<h5>:</h5>
	    </div>
  </div>
	<br>
	...
	<div class="row">
		<div class="col-md-4">
			<img src="../img/<?php echo $row['s_kematian']?>" alt="" width="450">
			<p style="text-align:center;">Surat Kematian</p>
		</div>
		<div class="col-md-4">
			<img src="../img/<?php echo $row['s_cerai']?>" alt="" width="450">
