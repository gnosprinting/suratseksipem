...
<?php
  ...
  <div class="row">
    ...
    <div class="col">
		<?php
			$sqli = mysqli_query($koneksi, "SELECT * FROM surat_tidakmampu");
			$jml = mysqli_num_rows($sqli);
			$nos = $jml+1;
		?>
		<div class="form-group">
			<label class="control-label">No Surat</label>
			<input type="text" name="no_surat" value="441.6/<?php echo $nos; ?>" class="form-control" readonly="true"></required>
		</div>
		<div class="form-group">
			<label class="control-label">Jenis Surat</label>
			<div class="">
				<input type="radio" name="jenis" value="1">Berobat
				<input type="radio" name="jenis" value="2">Beasiswa
				</div>
		</div>
		<!--
		<div class="form-group">
