...
<body>
    	<h3 style="text-align:center;">PENGAJUAN SURAT kematian</h3>
...
<div class="isi">
  <div class="content" style="padding:3% !important;">
	...
	<div class="row">
		...
		<div class="col-md-4">
			<img src="../img/<?php echo $row['s_ktp_pelapor']?>" alt="" width="450">
	...
	<div class="row">
		<div class="col-md-4">
			<img src="../img/<?php echo $row['s_ktp_mati']?>" alt="" width="450">
			<p style="text-align:center;">KTP Mati</p>
		</div>
		<div class="col-md-4">
			<img src="../img/<?php echo $row['s_rs']?>" alt="" width="450">
