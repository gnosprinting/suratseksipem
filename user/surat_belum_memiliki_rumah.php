...
$mySql="SELECT * FROM surat_belum_memiliki_rumah WHERE nik = $nik";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_belum_memiliki_rumah WHERE nik like '%$qcari%' or nama like '%$qcari%' ";
}
?>
<div class="card">
	<h2 style="margin:10px;">Data Surat Belum Memiliki Rumah</h2>
		<div class="form-group">
			<a href="surat_belum_memiliki_rumah_tambah.php?nik=<?php echo $nik;?>" class="btn btn-sm btn-primary " style="margin-left:10px;">Tambah data Surat Belum Memiliki Rumah</a>
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="surat_belum_memiliki_rumah.php">
								<input type="text" class="form-control" name="qcari" placeholder="Cari Surat Belum Memiliki Rumah..." autofocus/>
					</form>
		</div>
			</div>
...
?>
      ...
      <td class="text-center"><?php echo $kolomData['pekerjaan']; ?></td>
			...
			<td>
				...
				hapus</a>
				<a href="surat_belum_memiliki_rumah_cetak.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-success" style="margin-top:5px;">detail</a>
			</td>
		</tr>
	<?php } ?>
				</table>
