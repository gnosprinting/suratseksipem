...
$mySql="SELECT * FROM surat_domisili WHERE nik = $nik";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_domisili WHERE nik like '%$qcari%' or nama like '%$qcari%' ";
}
?>
<div class="card">
	<h2 style="margin:10px;">Data Surat Domisili</h2>
		<div class="form-group">
			<a href="surat_domisili_tambah.php?nik=<?php echo $nik;?>" class="btn btn-sm btn-primary " style="margin-left:10px;">Tambah data surat domisili</a>
...
?>
      ...
      <td class="text-center"><?php echo $kolomData['pekerjaan']; ?></td>
			...
			<td>
				...
				hapus</a>
				<a href="surat_domisili_cetak.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-success" style="margin-top:5px;">detail</a>
			</td>
		</tr>
	<?php } ?>
				</table>
