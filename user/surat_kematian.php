...
$mySql="SELECT * FROM surat_kematian WHERE nik = $nik";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_kematian WHERE nik like '%$qcari%' or nama like '%$qcari%' ";
}
?>
<div class="card">
	<h2 style="margin:10px;">Data Surat kematian</h2>
		<div class="form-group">
			<a href="surat_kematian_tambah.php?nik=<?php echo $nik;?>" class="btn btn-sm btn-primary " style="margin-left:10px;">Tambah data surat kematian</a>
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="surat_kematian.php">
...
?>
		<tr>
			...
			<td class="text-center"><?php echo $kolomData['nik_mati']; ?></td>
			...
			<td>
				...
				hapus</a>
				<a href="surat_kematian_cetak.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-success" style="margin-top:5px;">detail</a>
			</td>
		</tr>
	<?php } ?>
				</table>
