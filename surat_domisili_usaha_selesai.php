...
<?php
		...
		$update = mysqli_query($koneksi, "UPDATE surat_domisili_usaha SET status_surat='$status_surat' WHERE id='".$_GET['id']."'") or die(mysqli_error());
		if ($update) {
	?>
		...
		<meta http-equiv='refresh' content='1; url=surat_domisili_usaha.php'/>
<?php
			}
	}
}
