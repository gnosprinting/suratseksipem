...
include ('header.php');
$mySql="SELECT * FROM surat_domisili_usaha WHERE status_surat='diproses'";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM surat_domisili_usaha WHERE status_surat='diproses' nik like '%$qcari%' or nama like '%$qcari%' or no_surat like '%$qcari%' or tgl_surat like '%$qcari%'";
}
?>
<div class="card">
	<h2 style="margin:10px;">Data Surat Domisili Usaha</h2>
		<div class="form-group">
			<!-- <a href="surat_domisili_usaha_keseluruhan_cetak.php" class="btn btn-sm btn-primary " style="margin-left:10px;">Cetak Data</a> -->
			<div class="right"  style="margin-right:10px;">
					<form class="" method="POST" action="surat_domisili_usaha.php">
								<input type="text" class="form-control" name="qcari" placeholder="Cari surat domisili usaha..." autofocus/>
					</form>
		</div>
			</div>
	...
	<tr>
      ...
      <td class="text-center"><?php echo $kolomData['agama']; ?></td>
			...
			<td>
				...
				?>
				<!-- <a href="surat_domisili_usaha_edit.php?id=<?php //echo $kolomData['id'];?>" class="btn btn-sm btn-warning" style="margin-top:5px;">Proses surat</a>
				...
				?>
				<a href="surat_domisili_usaha_selesai.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-warning" style="margin-top:5px;">Selesaikan surat</a>
				<a href="surat_domisili_usaha_hapus.php?id=<?php echo $kolomData['id'];?>" title="Hapus data" onClick="confirm ('Yakin menghapus Data ini?')" class="btn btn-danger btn-sm">
				hapus</a>
				<a href="surat_domisili_usaha_cetak.php?id=<?php echo $kolomData['id'];?>" class="btn btn-sm btn-success" style="margin-top:5px;">cetak surat</a>
				<?php
					}
				?>
				<?php
