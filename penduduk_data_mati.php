...
$mySql="SELECT * FROM t_penduduk_mati GROUP BY nik";
if(isset($_POST['qcari'])) {
	$qcari=$_POST['qcari'];
	$mySql="SELECT * FROM t_penduduk_mati WHERE nik like '%$qcari%' or nama like '%$qcari%' GROUP BY nik";
}

?>

<div class="card">
	<h2 style="margin:10px;">Data Penduduk Mati</h2>
	<div class="form-group">
		...
		<div class="right"  style="margin-right:10px;">
			<form class="" method="POST" action="penduduk_data_mati.php">
