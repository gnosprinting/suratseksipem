...
<?php
	...
	if(isset($_POST['add'])){
		...
		//tgl_surat='$tgl_surat'
		$update = mysqli_query($koneksi, "UPDATE surat_kehilangan SET status_surat='$status_surat',ket_surat='$ket_surat',tgl_surat='$tgl_surat' WHERE id='$id'") or die(mysqli_error());
		if ($update) {
		?>
		...
		<meta http-equiv='refresh' content='3; url=surat_kehilangan.php'/>
		<?php
		}else{
	...
	?>
		<h2>Data Surat Kehilangan &raquo; Proses</h2>
		<hr />
	...
	<div class="form-group">
		...
		<input type="text" name="nama" value="<?php echo $row['nama'] ?>" class="form-control"
			...
			<div class="form-group">
				...
				<a class="btn btn-danger" href="surat_ektp.php">Kembali</a>
		</div>
  </div>
</form>
